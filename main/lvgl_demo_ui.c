...
void example_lvgl_demo_ui(lv_disp_t *disp)
{
    ...
    // // 允许旋转和缩放（开启变换属性）
    // lv_img_set_pivot(img, moiw_2014.header.w / 2, moiw_2014.header.h / 2); // 设定旋转中心
    ...
    // // 设置 GIF 文件路径（从 SPIFFS、LittleFS、SD 卡或 Flash 中加载）
    // lv_gif_set_src(gif, "A:/littlefs/miho.gif");  // 修改为你的路径
